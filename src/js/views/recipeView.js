...
class RecipeView extends View {
  ...
  addHandlerUpdateServings(handler) {
    this._parentEl.addEventListener('click', function (e) {
      ...
      let numServing = +btnServing.dataset.updateToPeople;
      if (numServing > 0) handler(numServing);
    })
  }
    ...
    <div class="recipe__details">
      ...
      <div class="recipe__info">
        ...
        <div class="recipe__info-buttons">
          <button data-update-to-people="${this._data.servings - 1}" class="btn--tiny btn--decrease-servings">
            <svg>
              <use href="${icons}#icon-minus-circle"></use>
            </svg>
          </button>
          <button data-update-to-people="${this._data.servings + 1}" class="btn--tiny btn--increase-servings">
            <svg>
